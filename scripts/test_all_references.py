# -*- coding: utf-8 -*-
"""
Test all fixed reference codes
"""
import sys
import io
...
print("=" * 60)
print("Test Project 1: Data Cleaning")
print("=" * 60)
try:
    data = {
    ...
    for idx, row in df.iterrows():
        if pd.isna(row['customer_id']):
            if row['amount'] and row['amount'] > 0:
                df.at[idx, 'customer_id'] = 'Guest_%d' % np.random.randint(1000, 9999)
    df['order_date'] = pd.to_datetime(df['order_date'], format=None, errors='coerce')
    df = df[df['order_date'] <= datetime.now()]
    print("[PASS] Project 1, records:", len(df))
except Exception as e:
    print("[FAIL] Project 1:", e)

print()
print("=" * 60)
print("Test Project 2: Pivot Table")
print("=" * 60)
try:
    data = {
    ...
    print("[PASS] Project 2, sessions:", df['session_id'].nunique())
except Exception as e:
    print("[FAIL] Project 2:", e)

print()
print("=" * 60)
print("Test Project 3: Apriori")
print("=" * 60)
try:
    cart_data = {
    ...
    print("[PASS] Project 3, rules:", len(confidence))
except Exception as e:
    print("[FAIL] Project 3:", e)

print()
print("=" * 60)
print("Test Project 4: RFM")
print("=" * 60)
try:
    data = {
    ...
    print("[PASS] Project 4, customers:", len(rfm))
except Exception as e:
    print("[FAIL] Project 4:", e)

print()
print("=" * 60)
print("Test Project 5: K-Means")
print("=" * 60)
try:
    np.random.seed(42)
    n = 20
    ...
    print("[PASS] Project 5, clusters:", df['cluster'].nunique())
except Exception as e:
    print("[FAIL] Project 5:", e)

print()
print("=" * 60)
print("Test Project 6: Anomaly Detection")
print("=" * 60)
try:
    np.random.seed(42)
    ...
    for idx in df.index:
        ...
        if std > 0:
            if val < mean - 2 * std:
                anomalies.append({'time': idx, 'type': 'drop', 'value': val})
            elif val > mean + 2 * std:
                anomalies.append({'time': idx, 'type': 'spike', 'value': val})
    print("[PASS] Project 6, anomalies:", len(anomalies))
except Exception as e:
    print("[FAIL] Project 6:", e)

print()
print("=" * 60)
print("Test Project 7: Attribution")
print("=" * 60)
try:
    clicks = pd.DataFrame({
    ...
    print("[PASS] Project 7, channels:", len(channel_stats))
except Exception as e:
    print("[FAIL] Project 7:", e)

print()
print("=" * 60)
print("Test Project 8: Text Cleaning")
print("=" * 60)
try:
    data = {
    ...
    print("[PASS] Project 8, valid comments:", (df['clean'] != '').sum())
except Exception as e:
    print("[FAIL] Project 8:", e)

print()
print("=" * 60)
print("Test Project 9: Pareto")
print("=" * 60)
try:
    np.random.seed(42)
    ...
    print("[PASS] Project 9, hot items:", (pareto['category'] == '爆款').sum())
except Exception as e:
    print("[FAIL] Project 9:", e)

print()
print("=" * 60)
print("Test Project 10: End-to-End")
print("=" * 60)
try:
    np.random.seed(42)
    orders = []
    ...
    print("[PASS] Project 10, categories:", len(cooccurrence.columns))
except Exception as e:
    print("[FAIL] Project 10:", e)
